...
@Entity({ tableName: 'event_director_application_references', schema: 'public' })
export class EventDirectorApplicationReference {
  @PrimaryKey({ type: 'uuid' })
  id: string = randomUUID();

  @ManyToOne(() => EventDirectorApplication, { fieldName: 'application_id' })
