...
/**
 * REST endpoints for ticket canned-response templates.
 *
 *   GET    /api/tickets/canned-responses       - list templates visible to caller
 *   POST   /api/tickets/canned-responses       - create
 *   PATCH  /api/tickets/canned-responses/:id   - update
 *   DELETE /api/tickets/canned-responses/:id   - delete
 *
