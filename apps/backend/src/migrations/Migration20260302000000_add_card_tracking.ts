...
export class Migration20260302000000_add_card_tracking extends Migration {
  async up(): Promise<void> {
    this.addSql(`ALTER TABLE "public"."memberships" ADD COLUMN "card_created_at" TIMESTAMPTZ NULL;`);
    this.addSql(`ALTER TABLE "public"."memberships" ADD COLUMN "card_assigned_at" TIMESTAMPTZ NULL;`);
    this.addSql(`ALTER TABLE "public"."memberships" ADD COLUMN "card_shipped_at" TIMESTAMPTZ NULL;`);
    this.addSql(`ALTER TABLE "public"."memberships" ADD COLUMN "card_tracking_number" TEXT NULL;`);
    this.addSql(`ALTER TABLE "public"."memberships" ADD COLUMN "card_notes" TEXT NULL;`);
  }
