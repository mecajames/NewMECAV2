...
import { staffSignaturesApi, StaffSignature } from '@/tickets/ticket-support-tools.api-client';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 to-slate-800 py-8 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-2xl font-bold text-white mb-2">My Reply Signature</h1>
