  ...
  const handleSave = async () => {
    try {
      ...
      if (isViewingSecondary && selectedProfile && selectedMembership) {
        ...
        // Save own profile. Empty birthday must go over as null — an empty
        // string is not a valid date for the DB column.
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-6">
            ...
            <>
              ...
              <div className="bg-slate-800 rounded-xl p-6 shadow-lg">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  {/* Birthday — PRIVATE. Only drives the automated birthday
                      email; never shown on any public page. */}
                  <div>
                    {isEditing ? (
                      <>
                        <label className="block text-sm font-medium text-gray-300 mb-2">
                          Birthday <span className="text-gray-500 font-normal">(private)</span>
                        </label>
                        <input
                          type="date"
                        ...
                        <p className="text-xs text-gray-500 mt-1">
                          Never shown publicly — we only use it to send you a birthday greeting from the MECA team.
                        </p>
                      </>
                    ) : (
                      <>
          ...
          <div className="bg-slate-800 rounded-xl p-6 shadow-lg">
            ...
            {/* NOTE: the member-facing "Privacy / activity tracking" opt-out
                panel that used to live here was REMOVED on James's order
                (2026-07-04): activity tracking is part of the membership
                agreement — every member is tracked, no member-facing toggle.
                The backend no longer honors analytics_opt_out and a
                migration reset any existing opt-outs. */}
