              ...
              <div className="mb-12">
                ...
                <div className="flex flex-col md:flex-row items-center md:items-end justify-center gap-4 mb-8">
                  ...
                  {leaderboard[1] && (() => {
                    ...
                    return (
                      <div className="flex flex-col items-center w-full md:w-auto order-2 md:order-1">
                        <div className="bg-slate-800 rounded-xl p-6 border-2 border-gray-400 mb-4 w-full max-w-xs md:max-w-none md:w-64 text-center">
                  ...
                  {leaderboard[0] && (() => {
                    ...
                    const mecaDisplay = getMecaIdDisplay(entry.meca_id, entry.membership_expiry);
                    return (
                      <div className="flex flex-col items-center w-full md:w-auto md:-mt-8 order-1 md:order-2">
                        <div className="bg-slate-800 rounded-xl p-6 border-4 border-yellow-500 mb-4 w-full max-w-xs md:max-w-none md:w-72 text-center shadow-2xl">
                  ...
                  {leaderboard[2] && (() => {
                    ...
                    const mecaDisplay = getMecaIdDisplay(entry.meca_id, entry.membership_expiry);
                    return (
                      <div className="flex flex-col items-center w-full md:w-auto order-3 md:order-3">
                        <div className="bg-slate-800 rounded-xl p-6 border-2 border-orange-500 mb-4 w-full max-w-xs md:max-w-none md:w-64 text-center">
