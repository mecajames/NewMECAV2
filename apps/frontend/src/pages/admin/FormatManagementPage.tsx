...
import { competitionFormatsApi, CompetitionFormat } from '../../api-client/competition-formats.api-client';
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-orange-900/20 to-slate-900 py-12 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8 flex items-center justify-between">
          <div>
            <h1 className="text-4xl font-bold text-white mb-2">Competition Formats</h1>
